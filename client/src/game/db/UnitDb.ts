...
export const AircraftDb: IAircraftModel[] = [
  ...
  },
  {
    ...
    jammingRange: 150,
    jammingStrength: 0.55,
    jammingModes: ["radar", "communications"],
    communicationDisruption: 0.35,
    dataSource: {
      speedSrc: "public approximate simulator value",
      maxFuelSrc: "public approximate simulator value",
      fuelRateSrc: "AI estimate; verify before use",
      rangeSrc: "public approximate simulator value",
    },
    units: {
      speedUnit: "knots",
      maxFuelUnit: "lbs",
