...
import { localizeSideName, localizeWeaponName } from "@/i18n/entityNames";
...
export default function WeaponCard(props: Readonly<WeaponCardProps>) {
  ...
  const weaponName = localizeWeaponName(props.weapon.name);
  const weaponClassName = localizeWeaponName(props.weapon.className);
        ...
        <CardHeader
          action={
            <Stack direction={"row"} spacing={0}>
              <Tooltip title={`Delete ${weaponName}`}>
            ...
            >
              ...
              <Typography variant="caption">
                ...
                <Typography variant="caption" component={"span"}>
                  {localizeSideName(props.sideName)}
                </Typography>
              </Typography>
            </Stack>
          }
