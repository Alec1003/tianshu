...
// Theme-aware sx so dark/light AICC themes flow through OL toolbar.
...
export default function Toolbar(props: Readonly<ToolBarProps>) {
    ...
    return (
      <Stack spacing={1} direction={"column"}>
        ...
        >
          ...
          <Chip
            variant="outlined"
            label={t("toolbar.recording.every", {
          ...
          />
          <Tooltip title={t("toolbar.recording.upload")}>
  ...
  const missionSection = () => {
    ...
    if (!sideMissions || !Array.isArray(sideMissions) || !sideMissions.length) {
      return <MenuItem disabled>{t("toolbar.mission.empty")}</MenuItem>;
    }
  ...
  const entityMenuButtons = () => {
    return (
      ...
      >
        ...
        <Tooltip title={t("toolbar.unit.addAircraft")}>
          <IconButton
        ...
        <Tooltip title={t("toolbar.unit.addAirbaseFromDb")}>
          <IconButton
        ...
        {/** Add Sam Menu/Button */}
        <Tooltip title={t("toolbar.unit.addSam")}>
          <IconButton
        ...
        <Tooltip title={t("toolbar.unit.addShip")}>
          <IconButton
        ...
        {/** Add Reference Point */}
        <Tooltip title={t("toolbar.unit.addReferencePoint")}>
          <IconButton onClick={handleReferencePointIconClick}>
            <EntityIcon type="referencePoint" />
          </IconButton>
        </Tooltip>
        {/**  Unit Db Functions */}
        <Tooltip title={t("toolbar.unit.dbTools")}>
        ...
        {/**  Enable Eraser */}
        <Tooltip title={t("toolbar.modes.eraser")}>
        ...
        {/**  Enable God Mode */}
        <Tooltip title={t("toolbar.modes.godMode")}>
        ...
        <Tooltip title={t("toolbar.modes.simulationLogs")}>
    ...
    <>
      ...
      >
        <MapToolbar variant="dense" sx={toolbarStyle} disableGutters>
          {props.drawerOpen ? (
            <Tooltip title={t("toolbar.drawer.close")}>
              <IconButton
                color="inherit"
                aria-label={t("toolbar.drawer.close")}
            ...
            <Tooltip title={t("toolbar.drawer.open")}>
              <IconButton
                color="inherit"
                aria-label={t("toolbar.drawer.open")}
      ...
      >
        ...
        >
          ...
          <Stack>
            ...
            <CardActions sx={{ display: "flex", justifyContent: "center" }}>
              ...
              >
                <Tooltip title={t("toolbar.scenario.new")}>
                ...
                <Tooltip title={t("toolbar.scenario.load")}>
                  ...
                  title={
                    isAuthenticated
                      ? cloudScenarios.length > 4
                        ? t("toolbar.scenario.saveCloudLimit")
                        : t("toolbar.scenario.saveCloud")
                      : t("toolbar.scenario.saveCloudLogin")
                  }
                >
                ...
                <Tooltip
                  title={
                    isAuthenticated || import.meta.env.VITE_ENV !== "production"
                      ? t("toolbar.scenario.download")
                      : t("toolbar.scenario.downloadLogin")
                  }
                >
                ...
                <Tooltip title={t("toolbar.scenario.editName")}>
            ...
            <CardActions sx={{ display: "flex", justifyContent: "center" }}>
              ...
              >
                <Tooltip title={t("toolbar.scenario.stepScenario")}>
                  <Chip
                    variant="outlined"
                    label={t("toolbar.time.step")}
                    onClick={handleStepClick}
                  />
                </Tooltip>
                <Tooltip title={t("toolbar.scenario.restartScenario")}>
                  <IconButton onClick={reloadScenario}>
                    <RestartAltIcon />
                  </IconButton>
                </Tooltip>
                <Tooltip title={t("toolbar.time.undo")}>
                  <IconButton onClick={handleUndo}>{<Undo />}</IconButton>
                </Tooltip>
                <Tooltip
                  title={
                    !scenarioPaused
                      ? t("toolbar.time.pauseScenario")
                      : t("toolbar.time.playScenario")
                  }
                >
                ...
                <Tooltip title={t("toolbar.scenario.toggleSpeed")}>
                  <Chip
          ...
          <List
            ...
            subheader={
              ...
              >
                {t("toolbar.drawer.featureControls")}
              </ListSubheader>
            }
          >
            <ToolbarCollapsible
              title={t("toolbar.recording.label")}
              prependIcon={RadioButtonCheckedIcon}
              content={recordingSection()}
              open={false}
            />
            <ToolbarCollapsible
              title={t("toolbar.drawer.entities")}
            ...
            />
            <ToolbarCollapsible
              title={t("toolbar.drawer.missions")}
        ...
        >
          ...
          >
            <Typography variant="body2">AICC</Typography>
