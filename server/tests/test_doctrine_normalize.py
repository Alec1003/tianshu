"""Regression：``app.panopticon._doctrine.normalize_scenario_payload``。
...
只 import 纯函数模块，不引导 PanopticonRuntime（避免 blade/gymnasium 依赖）。
"""
...
from app.panopticon._doctrine import (
